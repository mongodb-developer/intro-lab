...
<Screenshot src={"img/screenshots/20-mongodb-atlas/2-create-account/1-form.png"} alt="Account creation form" />
...
<Screenshot src={"img/screenshots/20-mongodb-atlas/2-create-account/2-verify-email.png"} alt="Verify your email address" />
