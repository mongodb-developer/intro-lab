...
<Screenshot src="img/screenshots/20-mongodb-atlas/3-create-cluster/1-overview.png" alt="Overview screenshot" />
...
<Screenshot src="img/screenshots/20-mongodb-atlas/3-create-cluster/2-deploy-database.png" alt="Create cluster screenshot" />
...
<Screenshot src="img/screenshots/20-mongodb-atlas/3-create-cluster/3-username.png" alt="Create a user screenshot" />
...
<Screenshot src="img/screenshots/20-mongodb-atlas/3-create-cluster/4-allow-ip.png" alt="Screenshot of the ip whitelisting screen" />
...
<Screenshot src="img/screenshots/20-mongodb-atlas/3-create-cluster/5-database-deployment.png" alt="Screenshot of the database deployment screen" />
