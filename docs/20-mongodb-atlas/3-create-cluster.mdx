...
1. For the cluster tier, pick **M0**, which is the free tier. In the **Name** input box, put a meaningful name for your cluster.
1. Uncheck the *Automate security setup* box. You will set up security manually in the next steps.
1. Uncheck the *Add sample dataset* box. You will import a dataset later in this tutorial.
